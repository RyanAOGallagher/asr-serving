...
5. Clone upstream `QwenLM/Qwen3-ASR` (localasr runs upstream commit `c17a131`, dated 2026-01-30) and drop `prod/` (or `shim/`) files on top; the servers import `qwen_asr` from it.
