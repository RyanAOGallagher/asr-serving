...
| `shim/` | 5090 box `/workspace/qwenasr_bench/streaming/` | Experimental anchor on stock vLLM serve, see `shim/SHIM_NOTES.md`. `cb_swap.sh` swaps `server_merged` ↔ `qwen-asr-serve :8021`. |
